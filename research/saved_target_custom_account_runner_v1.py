...
def run_saved_target_custom_account(root, out, config_path, candidates, parents, controls, build_frames, simulate_account):
    ...
    for period, frame, start, destination in [("evaluation", data, cfg["evaluation_start"], main),
        ...
        for cost_id, cost in cfg["costs"].items():
            ...
            for model in candidates:
                ...
                ledger, decisions = simulate_account(frame, dividends, cfg, cost, start, model,
