...
CONFIG = ROOT / "config/510300_forward_eps_valuation_consistency_policy_v2.json"
MANIFEST = ROOT / "config/510300_forward_eps_valuation_consistency_policy_v2_manifest.json"
OUT = ROOT / "reports/research/510300_forward_eps_valuation_consistency_policy_v2"
SOURCE = ROOT / "reports/research/510300_forward_eps_monthly_policy_v2_csi"
FEATURE_SOURCE = ROOT / "reports/research/510300_forward_eps_valuation_consistency_features_v2"
...
def freeze() -> None:
    ...
    freeze_policy("pe", __file__, MODELS)
