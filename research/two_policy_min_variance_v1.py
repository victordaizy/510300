...
OUT = ROOT / "reports/research/510300_two_policy_min_variance_v1"
CONFIG = ROOT / "config/510300_two_policy_min_variance_v1.json"
P76 = ROOT / "reports/research/510300_two_policy_risk_budget_v1"
P46 = ROOT / "reports/research/510300_panic_learned_equal_blend_v1"
PRIMARY = "TWO_POLICY_MIN_VARIANCE"
NAME = "两条原策略非负最小方差预算"
CONTROLS = {"PANIC_LEARNED_HALF": "原急跌与学习各半", "REARM_RIDGE": "原学习退出及等待新机会", "PANIC_ONLY": "原急跌回升单独策略", "BUY_HOLD": "买入持有", "TWO_POLICY_RISK_BUDGET": "第76轮倒数波动预算"}
...
def freeze():
    ...
    cfg.update(study_id="510300_TWO_POLICY_MIN_VARIANCE_V1", round=82, objective="MINIMIZE_TWO_REFERENCE_FULL_CALENDAR_SAMPLE_VARIANCE", registered_at=now(), primary=PRIMARY, candidate_configurations=1,
        risk_window=242, risk_clock="MONTH_FIRST_COMPLETE_CLOSE_NEXT_OPEN", state_cost="BASE", initial_budgets=[.5, .5],
        missing_or_zero_risk="NO_VIEW_KEEP_PREVIOUS_BUDGET", degenerate_difference="NO_VIEW_KEEP_PREVIOUS_BUDGET", rules="docs/510300_TWO_POLICY_MIN_VARIANCE_V1.md",
        new_model_fits=0, new_reference_accounts=0, previous_goal_turn_classification="PROGRESS_ROUND81_SOURCE_FIX_COMPLETE",
    ...
    paths = [Path(__file__), ROOT / "research/two_policy_min_variance_inputs_v1.py", ROOT / "research/event_clock_account_v1.py",
        ...
        ROOT / "tests/test_two_policy_min_variance_v1.py", OUT / "tests_receipt.json", ROOT / "config/510300_research_authority_v6.json"]
    ...
    print("第82轮单项非负最小方差预算已冻结，尚无新策略收益。", flush=True)
...
def run():
    ...
    write_json(OUT / "result.json", {"study_id": cfg["study_id"], "completed_at": now(), "status": "TWO_POLICY_MIN_VARIANCE_ACCOUNTS_COMPLETE",
