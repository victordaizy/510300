...
def simulate_price_streak_exit(data, dividends, config, cost, start, rule, spec, controller=None, entry_gate=None):
        ...
        if account.shares:
            ...
            if entry_gate is not None:
                ...
                if not entry_check["entry_allowed"]:
                    qty, action = 0, "当前价格退出条件仍成立或输入缺失，暂缓本次买入"
