...
CONFIG = ROOT / "config/510300_forward_eps_two_institution_policy_v3.json"
MANIFEST = ROOT / "config/510300_forward_eps_two_institution_policy_v3_manifest.json"
OUT = ROOT / "reports/research/510300_forward_eps_two_institution_policy_v3"
SOURCE = ROOT / "reports/research/510300_forward_eps_monthly_policy_v2_csi"
FEATURE_SOURCE = ROOT / "reports/research/510300_forward_eps_two_institution_features_v3"
...
def freeze() -> None:
    ...
    freeze_policy("two", __file__, MODELS)
