...
OUT = ROOT / "reports/research/510300_volatility_term_v1"
P46 = ROOT / "reports/research/510300_panic_learned_equal_blend_v1"
CONFIG = ROOT / "config/510300_volatility_term_v1.json"
...
def run():
    ...
    for period, frame, start, destination in [("evaluation", data, cfg["evaluation_start"], main),
        ...
        for cost_id, cost in cfg["costs"].items():
            ...
            require(decisions.execution_date.equals(decisions.source_execution_date), "海外观察与执行日错位")
