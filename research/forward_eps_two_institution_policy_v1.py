...
CONFIG = ROOT / "config/510300_forward_eps_two_institution_policy_v1.json"
MANIFEST = ROOT / "config/510300_forward_eps_two_institution_policy_v1_manifest.json"
OUT = ROOT / "reports/research/510300_forward_eps_two_institution_policy_v1"
SOURCE = ROOT / "reports/research/510300_forward_eps_monthly_policy_v2_csi"
FEATURE_SOURCE = ROOT / "reports/research/510300_forward_eps_two_institution_features_v1"
...
def freeze() -> None:
    ...
    for key in ["rule", "source_layout_correction_only", "source_fact_version", "primary_scope", "diagnostic_scope"]:
        config.pop(key, None)
    config.update({"study_id": "510300_FORWARD_EPS_TWO_INSTITUTION_POLICY_V1", "primary": "S1_POOLED_EPS",
    ...
    paths = [Path(__file__), ROOT / "docs/510300_FORWARD_EPS_TWO_INSTITUTION_POLICY_V1.md",
             ROOT / "research/forward_eps_two_institution_features_v1.py",
             ROOT / "tests/test_forward_eps_two_institution_features_v1.py", FEATURE_SOURCE / "manifest.json",
             ROOT / "research/forward_eps_soochow_facts_v1.py", ROOT / "tests/test_forward_eps_soochow_facts_v1.py",
    ...
    print("第十九轮三候选已登记：双机构EPS、同月份东吴EPS、EPS加信息质量；尚未运行账户。", flush=True)
