...
def validate_config(config: dict[str, Any]) -> None:
    expected = {
        ("protocol", "project_id"): "510300_THREE_STATE_TREND_ROUTER_V1",
        ...
        ("selection_bias", "prior_manifest_count"): 345,
        ("selection_bias", "non_manifest_prefreeze_failed_attempt_count"): 1,
        ("selection_bias", "expected_total_trial_count_including_current"): 347,
    }
