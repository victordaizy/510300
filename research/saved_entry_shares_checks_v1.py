...
def verify_preserved_shares_accounts(out, cfg, result, data, dividends, expected_targets, comparison_models=()):
    ...
    for period in ["evaluation", "earlier_diagnostic"]:
        ...
        for cost_id in cfg["costs"]:
            ...
            require(np.array_equal(decisions.requested_quantity, requests), "目标账户请求未使用自身净值和正目标保持份额规则")
