...
OUT = ROOT / "reports/research/510300_financial_original_facts_v1"
MANIFEST = ROOT / "config/510300_financial_original_facts_v1_manifest.json"
NAMES = {
...
LABELS = {
    ...
    "PARENT_NET_PROFIT_YTD": ["归属于母公司股东的净利润", "归属于母公司所有者的净利润", "归属于本行股东的净利润", "本行股东的净利润"],
...
def freeze():
    paths = [Path(__file__), ROOT / "docs/510300_FINANCIAL_ORIGINAL_FACTS_V1.md", ROOT / "tests/test_financial_original_facts_v1.py", REPAIR / "result.json"] + input_files()
