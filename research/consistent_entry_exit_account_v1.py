...
def simulate_consistent_exit(data, dividends, config, cost, start, rule, spec, controller=None, entry_gate=None):
        ...
        if account.shares:
            ...
            if entry_gate is not None:
                ...
                if not entry_check["entry_allowed"]:
                    qty, action = 0, "入场预测不支持继续持有，暂缓本次买入"
