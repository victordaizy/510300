...
CONFIG = ROOT / 'config/510300_post_selection_extension_inputs_v1_1.json'
...
def main():
    ...
    require(OUT.is_dir() and not list(OUT.iterdir()) and not CONFIG.exists(), '精度修复仅可接续尚无接纳输出的本项')
    ...
    paths.extend([ROOT/'config/510300_post_selection_extension_inputs_v1.json',ROOT/'research/post_selection_extension_inputs_v1.py',ROOT/'reports/research/510300_round212_numeric_representation_fix.json'])
    ...
    cfg.update(study_id='510300_POST_SELECTION_EXTENSION_INPUTS_V1', round=212, registered_at=now(), primary=PRIMARY,
        ...
        numerical_representation_tolerance_cny=1e-6,amends='config/510300_post_selection_extension_inputs_v1.json',
