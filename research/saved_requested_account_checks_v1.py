...
def verify_requested_target_accounts(out, cfg, result, data, dividends, expected_targets, expected_requests, comparison_models=()):
    ...
    for period in ["evaluation", "earlier_diagnostic"]:
        ...
        for cost_id in cfg["costs"]:
            ...
            requests = np.asarray(expected_requests(targets, prior, old_shares, prices, cfg), dtype=int)
