...
def simulate_self_performance_exit(data, dividends, config, cost, start, rule, spec, controller=None, entry_gate=None):
        ...
        if account.shares:
            ...
            if entry_gate is not None:
                ...
                if not entry_check["entry_allowed"]:
                    qty, action = 0, "原策略自身过去一年净收益未通过检查，暂缓本次买入"
