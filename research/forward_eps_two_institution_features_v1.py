...
OUT = ROOT / "reports/research/510300_forward_eps_two_institution_features_v1"
SOURCES = {
    "guosen": {
    ...
    "soochow": {
        ...
        "facts": "510300_forward_eps_soochow_facts_v1",
    },
}
...
def freeze() -> None:
    ...
    paths = [Path(__file__), ROOT / "tests/test_forward_eps_two_institution_features_v1.py",
             ROOT / "docs/510300_FORWARD_EPS_TWO_INSTITUTION_FEATURES_V1.md", PANEL,
             ...
             ROOT / "reports/research/510300_forward_eps_soochow_facts_v1/manifest.json",
    ...
    save(OUT / "manifest.json", {"registered_at": now(), "sources": SOURCES,
         "same_institution_revision_required": True, "company_equal_weight_after_institution_mean": True,
...
def run() -> None:
    ...
    result = {"study_id": "510300_FORWARD_EPS_TWO_INSTITUTION_FEATURES_V1", "completed_at": now(),
