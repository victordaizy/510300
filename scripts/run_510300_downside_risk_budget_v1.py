...
from downside_risk_budget_v1 import ContractError, run_study  # noqa: E402


def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="运行510300下行风险预算V1")
...
def main() -> int:
    ...
    summary = {
        ...
        "risk_gate_passed": report["risk_gate_passed"],
