...
from oil_trend_monthly_timing_v1 import ContractError, run_study  # noqa: E402


def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="运行510300原油趋势月度择时V1")
...
def main() -> int:
    ...
    summary = {
        ...
        "historical_target_achieved": report["adjudication"]["historical_target_achieved"],
