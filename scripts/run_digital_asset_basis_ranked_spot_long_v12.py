...
from scripts.freeze_digital_asset_basis_ranked_spot_long_v12 import verify
...
def write_failure_report(
    ...
    report = {
        ...
        "decision": {
            ...
            "next_step": "保留V12失败并关闭同候选复验；不得修改5日基差、90%现货仓位、两资产、成本、交割日、容量或风险门救回",
        },
