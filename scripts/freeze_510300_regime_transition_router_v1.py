...
from regime_transition_router_v1 import (  # noqa: E402
    CONFIG_PATH,
    MANIFEST_PATH,
    audit_inputs,
    load_config,
...
TRACKED_FILES = [
    "config/510300_regime_transition_router_v1.yaml",
    "docs/510300_REGIME_TRANSITION_ROUTER_V1_SPEC.md",
    "research/regime_transition_router_v1.py",
    "scripts/acquire_510300_regime_transition_router_v1_cgb.py",
    "scripts/freeze_510300_regime_transition_router_v1.py",
    "scripts/run_510300_regime_transition_router_v1.py",
    "scripts/audit_510300_regime_transition_router_v1_outputs.py",
    "tests/test_510300_regime_transition_router_v1.py",
]
...
def _run_synthetic_tests() -> dict[str, Any]:
    ...
    result = {
        ...
        "real_historical_outcomes_read": False,
    }
...
def freeze() -> dict[str, Any]:
    ...
    if preexisting:
        raise RuntimeError(f"冻结前已经存在真实结果或结果审计：{preexisting}")
    ...
    if data_audit["boundaries"]["future_outcomes_read"]:
        raise RuntimeError("输入审计错误地读取了未来条件路径")
    ...
    manifest = {
        ...
        "state": "FROZEN_BEFORE_FIRST_OUTCOME_READ",
        ...
        "no_rescue_contract": {
            ...
            "state_count_expansion_after_result": "FORBIDDEN",
            "same_history_module_research_if_state_gate_fails": "FORBIDDEN",
        },
    ...
    receipt = {
        ...
        "outcome_read_before_freeze": False,
        "strategy_return_read_before_freeze": False,
        "phase_2_executed_before_freeze": False,
        "live_trading_authorized": False,
    }
