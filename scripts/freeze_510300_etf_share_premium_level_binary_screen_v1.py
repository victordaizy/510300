"""冻结510300 ETF份额与折溢价水平二元筛选的协议、程序、测试和输入。"""
...
SOURCE_PATHS = [
    ...
    ROOT / "scripts" / "freeze_510300_etf_share_premium_level_binary_screen_v1.py",
    ROOT / "tests" / "test_etf_share_premium_level_binary_screen_v1.py",
]
...
def main() -> int:
    ...
    if protocol["study_id"] != "510300_ETF_SHARE_PREMIUM_LEVEL_BINARY_SCREEN_V1":
    ...
    manifest = {
        ...
        "same_day_close_execution_forbidden": bool(
            contract["information_clock"]["same_day_close_execution_forbidden"]
        ),
        ...
        "post_run_percentile_direction_window_or_combination_rescue": "FORBIDDEN",
