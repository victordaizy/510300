...
from research.forward_eps_corrected_account_attribution_v1 import OUT, ACCOUNTS, COMPONENTS, R11
...
def main():
    ...
    for row in summary.to_dict("records"):
        ...
        np.testing.assert_allclose(frame.cost_cny, original.commission.to_numpy() + original.slippage_cost.to_numpy(), atol=1e-10, rtol=0)
    ...
    save(OUT / "saved_numerical_verification.json", {"checked_at": now(),
        ...
        "random_samples_regenerated": 0, "security_audit_performed": False}, exclusive=True)
