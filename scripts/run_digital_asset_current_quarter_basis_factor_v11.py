...
from scripts.freeze_digital_asset_current_quarter_basis_factor_v11 import verify
...
def write_failure_report(
    ...
    report = {
        ...
        "decision": {
            ...
            "next_step": "保留V11失败并关闭同候选复验；不得修改5日基差、两资产、0.45/0.45、成本、交割日、容量或风险门救回",
        },
