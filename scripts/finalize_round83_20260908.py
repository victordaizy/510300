...
import numpy as np
import pandas as pd
from research.two_policy_tail_loss_v1 import ROOT, OUT as RESEARCH, CONFIG, PRIMARY, P76
...
OUT = ROOT / "deliverables/510300尾部损失预算_第83轮_20260908"
DOCUMENT = OUT / "尾部损失预算_结果及中文规则.md"
INDEX = ROOT / "reports/research/510300_sharpe_1_2_latest_research.json"
NEXT = ROOT / "docs/510300_AFTER_TAIL_LOSS_WEALTH_BUDGET_20260908.md"


def main():
    index = json.loads(INDEX.read_text(encoding="utf-8"))
    require(index["latest_completed_round"]["round"] == 82 and not OUT.exists(), "第83轮前序或交付状态不符")
        ...
        for t in range(first-1, len(f)-1):
            ...
            if scheduled:
                ...
                if count < cfg["risk_window"]:
                    ...
                    status = "TAIL_LOSS_BUDGET_AVAILABLE"
    ...
    receipt = {"verified_at": now(), "status": "KEY_EMPIRICAL_TAIL_GLOBAL_OPTIMUM_AND_COMPLETE_ACCOUNTS_CHECKED", "risk_update_checks": len(checks),
    ...
    status = "COMPLETED_TAIL_LOSS_BUDGET_TARGET_NOT_MET"
