...
from scripts.freeze_digital_asset_spot_low_volatility_stop_loss_v10 import verify
...
def write_failure_report(
    ...
    report = {
        ...
        "decision": {
            ...
            "next_step": "保留V10失败并关闭同候选复验；不得修改180日波动、半年选择、三币集中、5%月内止损、成本、容量或风险门救回",
        },
