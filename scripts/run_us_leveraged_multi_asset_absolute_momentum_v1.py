...
from scripts.freeze_us_leveraged_multi_asset_absolute_momentum_v1 import verify
...
def main() -> int:
    parser = argparse.ArgumentParser(description="运行美国杠杆多资产绝对动量V1可见期")
    parser.add_argument(
