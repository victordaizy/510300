param(
    [string]$TaskName = "Codex-Priority-Forward-Authoritative-Status-V1.8"
)
...
$runner = Join-Path $projectRoot "scripts\render_priority_forward_authoritative_status_v1_8.py"
$reportFile = Join-Path $projectRoot "reports\audit\priority_forward_authoritative_status_v1_8.json"
$reportMarkdownFile = Join-Path $projectRoot "reports\audit\PRIORITY_FORWARD_AUTHORITATIVE_STATUS_V1_8.md"
$reportSnapshotDirectory = Join-Path $projectRoot "reports\audit\priority_forward_authoritative_status_runs_v1_8"
$taskStatusFile = Join-Path $projectRoot "reports\audit\priority_forward_authoritative_status_task_v1_8.json"
$taskReceiptDirectory = Join-Path $projectRoot "reports\audit\priority_forward_authoritative_status_task_runs_v1_8"
$logDirectory = Join-Path $projectRoot "output\priority_forward_authoritative_status_logs_v1_8"
