...
from scripts.freeze_us_liquid_treasury_multi_asset_absolute_momentum_v2 import verify
...
def main() -> int:
    parser = argparse.ArgumentParser(description="运行美国高流动性美债多资产V2可见期")
    parser.add_argument(
