...
def main() -> int:
    ...
    if config["protocol"]["project_id"] != "510300_THREE_STATE_TREND_ROUTER_V1_0_1":
    ...
    tracked_relatives = [
        "config/510300_three_state_trend_router_v1_0_1.yaml",
        "docs/510300_THREE_STATE_TREND_ROUTER_V1_SPEC.md",
        "research/three_state_trend_router_v1_0_1.py",
        "scripts/freeze_510300_three_state_trend_router_v1_0_1.py",
        "scripts/run_510300_three_state_trend_router_v1_0_1.py",
        "tests/test_510300_three_state_trend_router_v1_0_1.py",
        "reports/data_quality/510300_three_state_trend_router_v1_inputs.json",
        "reports/audit/510300_three_state_trend_router_v1_hash_transcription_failure.json",
        "backtest/engine.py",
    ]
    input_relatives = [
    ...
    manifest = {
        ...
        "correction": {
            "class": "PRE_OUTCOME_INPUT_HASH_TRANSCRIPTION_ONLY",
            "predecessor_manifest": "config/510300_three_state_trend_router_v1_manifest.json",
            "predecessor_manifest_sha256": "0749ad2baec46aff0e89d867128639ccac4e9e9f7448b2537a5bfef877bf4706",
