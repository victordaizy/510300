...
from csi300_absorption_ratio_timing_v1 import ContractError, run_study  # noqa: E402


def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="运行510300沪深300PCA吸收率择时V1")
...
def main() -> int:
    ...
    try:
        ...
        return 2
    except Exception as exc:  # pragma: no cover - 保留PROGRAM_FAILED语义
        payload = {
