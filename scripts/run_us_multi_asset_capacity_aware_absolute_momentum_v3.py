...
from scripts.freeze_us_multi_asset_capacity_aware_absolute_momentum_v3 import verify
...
def main() -> int:
    parser = argparse.ArgumentParser(description="运行美国多资产容量感知绝对动量V3可见期")
    parser.add_argument(
