...
import numpy as np
import pandas as pd
from research.synthetic_fear_recovery_v1 import ROOT, OUT as RESEARCH, CONFIG, PRIMARY
...
OUT = ROOT / "deliverables/510300价格恐慌回落_第85轮_20260908"
DOCUMENT = OUT / "价格恐慌回落_结果及中文规则.md"
INDEX = ROOT / "reports/research/510300_sharpe_1_2_latest_research.json"
NEXT = ROOT / "docs/510300_AFTER_SYNTHETIC_FEAR_LIQUIDITY_EXIT_20260908.md"


def main():
    index = json.loads(INDEX.read_text(encoding="utf-8"))
    require(index["latest_completed_round"]["round"] == 84 and not OUT.exists(), "85前序或交付状态不符")
    ...
    receipt = {"verified_at": now(), "status": "KEY_INDEPENDENT_FEAR_SCALE_CAUSAL_PREFIX_AND_COMPLETE_ACCOUNTS_CHECKED", "prefix_days": len(early_f), "independent_factor_rows": len(main_f),
