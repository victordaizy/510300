...
from research.close_return_buy_gate_batch_inputs_v1 import CANDIDATES, MODELS, PRIMARY, SETTINGS, gate_frames, gate_request, market_factors, simulate_gate_account
...
def test_dividend_neutral_zero_one_percent_boundaries_and_missing():
    ...
    np.testing.assert_array_equal(factors.buy_allowed_r00, [True, False, False, True, True, False, False])
    np.testing.assert_array_equal(factors.buy_allowed_r01, [True, True, False, True, True, False, False])
