...
from research.a_share_hs_cash_tender_offer_evaluation_v1_0_2 import (
...
from scripts.run_a_share_hs_cash_tender_offer_evaluation_v1_0_2 import (
...
def test_h00300_open_bridge_preserves_total_return_close_and_uses_intraday_ratio(
    ...
    assert receipt["status"] == "PASS_H00300_PRICE_INDEX_OPEN_BRIDGE_VALIDATED"
