...
- 生成时间：`2026-08-19T19:56:01.019502+08:00`
...
- 状态：`BLOCKED_LOCAL_TASK_SCHEDULER_PERMISSION`
- 已核验安装：`False`
- 手动运行器已验证：`True`
...
- `BLOCK` `WINDOWS_TASK_SCHEDULER` `BLOCKED_LOCAL_TASK_SCHEDULER_PERMISSION`：手动运行器已验证，但本机权限不足，三个Windows计划任务尚未核验安装。
