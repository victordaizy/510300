...
- 生成时间：`2026-08-22T00:19:33.181042+08:00`
...
- 最近任务收据：`reports/forward/industry_expectation_gap_v1_evaluation/task_runs/20260820T0905031718764Z_11912.json`
...
- `WARNING` `PRIMARY_MARKET_PCF_IOPV` `PROGRAM_FAILED`：ParseException: 所在位置 C:\Users\戴周阳\Documents\New project 8\scripts\run_510300_primary_market_forward.ps1:73 字符: 53
+         throw "2涓囧厓绾搁潰淇″彿鐢熸垚澶辫触锛岄€€鍑虹爜锛?LASTEXITCODE"
+                                                     ~
字符串缺少终止符: "。

所在位置 C:\Users\戴周阳\Documents\New project 8\scripts\run_510300_primary_market_forward.ps1:44 字符: 23
+ if ($SkipPaperSignal) {
+                       ~
语句块或类型定义中缺少右“}”。
